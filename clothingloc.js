...
function interleave(map) {
      ...
      if (style.getState() === H.map.Style.State.READY) {
        ...
        // Add a circular transparent layer around an added place
         ...
         var circle = new H.map.Circle(
          {lat: 22.296835343270526, lng:73.20807073212524}, // Coordinates of the added place
        ...
        map.addObject(circle);
         ...
         var circle = new H.map.Circle(
          {lat: 22.31309613803979, lng:73.18388811385036}, // Coordinates of the added place
          1000, // Radius of the circle in meters
          { style: {fillColor: 'rgba(0, 0, 255, 0.3)', strokeColor: 'rgba(0, 0, 255, 1)', lineWidth: 2} } // Transparent fill color
        );
        map.addObject(circle);
        ...
        var circle = new H.map.Circle(
          {lat: 22.28807910261463, lng:73.15289835704881}, // Coordinates of the added place
  ...
  var additionalPlaces = [
   // Example additional place 1
    {lat:22.296835343270526, lng:73.20807073212524},
    {lat:22.31309613803979, lng:73.18388811385036},
    {lat:22.28807910261463, lng:73.15289835704881},
